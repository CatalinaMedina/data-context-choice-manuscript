...
(Neumann et al.~2013, Bibby 2003, Brearley et al.~2018, Cobb \& Moore
1997, Cobb 1992) and engage with the discipline (Hall 2011). Numerous
recommendations exist on how to teach with real data and where to find
it (Hall 2011, Singer \& Willett 1990). We believe statistics should be
taught as an investigative tool to learn from data about the world.
...
before the end of the course. We are not arguing for students to always
be given a choice though. Be conscious of when you want all students to
interact with a certain data context, versus when you are ok with them
having a choice.
